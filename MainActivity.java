...
public class MainActivity extends Activity {
    ...
    public void getFormWidgets()
    {
        ...
        adapter=new ArrayAdapter<JobInWeek> (this, android.R.layout.simple_list_item_1, arrJob);  //dổ dữ liệu vào adapter
        lvCv.setAdapter(adapter);//hiển thị ra list view
    }
...
//class  bắt sự kiện cho listview
    private class MyListViewEvent implements OnItemClickListener, OnItemLongClickListener
    {
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
            ...
            Toast.makeText(MainActivity.this, arrJob.get(arg2).getDesciption(), Toast.LENGTH_LONG).show();
        }
